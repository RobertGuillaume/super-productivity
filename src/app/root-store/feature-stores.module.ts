...
import { SolidArchiveStatePersistenceEffects } from '../solid-data/solid-archive-state-persistence.effects';
...
@NgModule({
  ...
  imports: [
    ...
    EffectsModule.forFeature([SolidArchiveStatePersistenceEffects]),
