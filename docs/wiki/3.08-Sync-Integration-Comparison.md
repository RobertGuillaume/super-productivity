...
Solid authentication and can either open an existing Pod directly or explicitly
upload the current local profile before a device hydrates from Solid. Compatible
